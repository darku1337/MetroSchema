...
if (SERVER) then
	...
	function PLUGIN:CharacterSave(client)
		local index = client.character.index
	...
	function PLUGIN:PlayerLoadedChar(client)
		...
		for k, v in pairs( buffvars ) do
			if self.playerVars[index][v] then
				...
				print(self.playerVars[index][v], client:Name())
			end
		end
	end

	function PLUGIN:LoadData()
		self.buffPoints = nut.util.ReadTable("buff_points")
		self.playerVars = nut.util.ReadTable("buff_playervars")
	end

	function PLUGIN:SaveData()
		nut.util.WriteTable("buff_points", self.buffPoints)
		nut.util.WriteTable("buff_playervars", self.playerVars)
	end
